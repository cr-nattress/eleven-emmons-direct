...
describe('BookingWidget Component', () => {
  ...
  it('renders the booking section', () => {
    ...
    expect(screen.getByText('Check availability and reserve your dates')).toBeInTheDocument()
  })
  ...
  it('shows placeholder widget message', () => {
    ...
    expect(screen.getByText(/booking widget will appear here/i)).toBeInTheDocument()
  })
  ...
  it('displays environment setup hint', () => {
    ...
    expect(screen.getByText(/NEXT_PUBLIC_HOSPITABLE_WIDGET_ID/i)).toBeInTheDocument()
  })
})
